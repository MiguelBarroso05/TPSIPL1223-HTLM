        ...
        <div class="col-lg-5">
            <div class="card shadow-lg border-0 rounded-lg mt-5">
                <div class="card-header"><h3 class="text-center font-weight-light my-4">Login</h3></div>
                   	<div class="card-body">
                   	    <form method="post">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="inputPassword" type="password" placeholder="Password" name="log_senha"/>
                ...
                <div class="card-footer text-center py-3">
                    <div class="small"><a href="?nav=register">Não tem conta? Registe-se!</a></div>
                </div>
            </div>
        </div>
    </div>
...
<?php 
    if(isset($_POST['bt_login'])){
        func_login($_POST['log_email'], $_POST['log_senha']);
    }
?>